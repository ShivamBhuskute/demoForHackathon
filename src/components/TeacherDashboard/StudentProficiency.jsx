...
const StudentProficiency = () => {
    ...
    return (
        <div className="student-proficiency p-4 bg-slate-200 rounded-lg shadow-lg mx-auto max-w-screen-sm sm:max-w-screen-md md:max-w-screen-lg lg:max-w-screen-xl">
                                ...
                                <tr key={index} className={`${student.bgColor} p-4 border-b`}>
                                    ...
                                    <td className="p-2 flex items-center">
                                        <div className="w-20 h-4 bg-gray-200 mr-2 rounded-full relative">
                                            <div
                                                className={`h-full rounded-full absolute ${getBgColor(average)}`}
                                                style={{ width: `${average}%` }}
                                            ></div>
                                        </div>
